...
/**
 * Storage class for variables affecting feel of platforming.<p>
...
public class PlatformingConstants {
    ...
    private static double maxAirSpeed = MAX_WALK_SPEED; // max horiz airSpeed of player (set based on if player can run or not)
